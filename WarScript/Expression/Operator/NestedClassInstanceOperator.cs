...
{
    public class NestedClassInstanceOperator : BinaryOperatorExpression
    {
        public NestedClassInstanceOperator(IExpression left, IExpression right) : base(left, right) { }
        ...
        public override IValue Evaluate()
        {
            ...
            return ExceptionContext.RaiseException($"Unable to access class's nested class `{Right}`");
        }
    }
}