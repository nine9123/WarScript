...
namespace WarScript.Expression.Operator
{
    ...
    {
        public LessThanOperator(IExpression left, IExpression right) : base(left, right) { }
        ...
        public override IValue Evaluate()
        {
            ...
            if (left == NullValue.Instance || right == NullValue.Instance)
                return ExceptionContext.RaiseException($"Unable to perform less than for NULL values `{left}`, `{right}`");
