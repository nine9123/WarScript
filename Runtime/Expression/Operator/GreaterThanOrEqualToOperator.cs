...
{
    public sealed class GreaterThanOrEqualToOperator : BinaryOperatorExpression
    {
        ...
        public override WarValue Evaluate()
        {
            ...
            if (left.IsNull || right.IsNull)
                return _script.RaiseException($"Unable to perform greater than or equal to for NULL values `{left}`, `{right}`");
